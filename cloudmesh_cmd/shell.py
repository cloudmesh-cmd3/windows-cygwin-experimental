...
#Now use the other shellUniversial and implement these methods
...
#           return f(args).rstrip('\n')
    ...
    # THIS WAY ITS PORTABLE TO WHAT WE HAVE DONE ELSEWHERE
    # ok?
    ...
    # NOTE THE NONE WE CHANGE BEHAVIOR OF WHICH
    @classmethod
